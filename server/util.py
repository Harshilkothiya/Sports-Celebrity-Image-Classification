...
# if model predict any number this function return its currsponding name 
...
def load_saved_artifacts():
    ...
    # print("__class_name_to_number", __class_name_to_number)
    # print("__class_number_to_name", __class_number_to_name)
...
# cv img ne base64 ma convert akre
...
# img ma 2 eye and face sarkhu chhe e chake kare
